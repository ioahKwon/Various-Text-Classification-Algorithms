...
newpath = './2015312904_KwonJoonWoo_MLP.txt'
f = open(newpath,'w')
...
# Calculate TF-IDF values for train articles.
...
classifier_MLP = MLPClassifier(hidden_layer_sizes=(100, ), activation = 'tanh',
                              solver = 'adam', batch_size ='auto',
                              learning_rate_init=0.001, max_iter=200)
classifier_MLP.fit(train_TFIDF,train_labels)
predict_test = classifier_MLP.predict(test_TFIDF)
