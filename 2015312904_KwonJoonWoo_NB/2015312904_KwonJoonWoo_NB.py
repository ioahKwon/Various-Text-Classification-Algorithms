# -*- coding: utf-8 -*-
"""2015312904_KwonJoonWoo_NB

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jazQPtMj6Y3dcwfTU5fh9sloEhBIeD6e
"""
...
newpath = './2015312904_KwonJoonWoo_NB.txt'
f = open(newpath,'w')
...
# Calculate TF values for train articles.
tfvect_train = CountVectorizer()
tfvect_train.fit_transform(train_article)
train_TF = tfvect_train.transform(train_article).toarray().tolist()

print("Num of Train data: ",len(train_TF))
print("-------------------------------------------")
del temp_article [:]
...
# Create TF of train set
test_TF = tfvect_train.transform(test_article).toarray().tolist()

print("Num of Test data: ",len(test_TF))
print("-------------------------------------------")
...
NB_classifier.fit(train_TF,train_labels)
predict_test = NB_classifier.predict(test_TF)
