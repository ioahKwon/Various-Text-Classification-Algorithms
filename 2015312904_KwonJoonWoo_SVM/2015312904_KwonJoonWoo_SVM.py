...
newpath = './2015312904_KwonJoonWoo_SVM.txt'
f = open(newpath,'w')
...
SVM_classifier = LinearSVC(C=1.0, max_iter=1000)
SVM_classifier.fit(train_TFIDF,train_labels)
predict_test = SVM_classifier.predict(test_TFIDF)
